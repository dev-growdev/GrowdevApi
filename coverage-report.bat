...
dotnet restore GrowdevApi.slnx
dotnet build GrowdevApi.slnx --configuration Release --no-restore

REM Run tests with coverage
dotnet test GrowdevApi.slnx --no-restore --verbosity normal ^
...
echo.
echo Coverage report generated at %CD%/TestResults/CoverageReport/index.html
